	...
	<div class="col-md-12 content-box" align="left">
		...
		<div id="replyPostBox">
			...
			<form>
				...
				<div id="rrp_indicator"><span></span>에게 대댓글<button type="button" class="close" onclick="fnResetRereply()">&times;</button></div>
		...
		<div id="replyBox">
			...
			<c:forEach items="${replies}" var="reply">
				<div>
					...
					<span onclick="fnSetRereply('${reply.rp_pos}', '${reply.rp_writer}')">댓글달기</span><br>
